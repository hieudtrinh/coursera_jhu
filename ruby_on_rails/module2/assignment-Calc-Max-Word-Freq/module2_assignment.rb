...
class LineAnalyzer
  ...
  def calculate_word_frequency()
    ...
    @highest_wf_words.concat frequency.select { |key,value| value == @highest_wf_count}.keys
  end
end
...
class Solution
  ...
  def calculate_line_with_highest_frequency()
    ...
    # Alternatively:
    @highest_count_words_across_lines = 
      @analyzers.select{|analyzer| analyzer.highest_wf_count == @highest_count_across_lines}
  end
  ...
  def print_highest_word_frequency_across_lines()
    @highest_count_words_across_lines.each do |analyzer|
      puts ("#{analyzer.highest_wf_words} (appear in line number #{analyzer.line_num})")
    end
  end
end
